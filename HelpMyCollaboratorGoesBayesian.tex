...
statistical analysis: intuitive probabilities, no rigid assumptions
about the data, better estimation of complicated models, and better
precautions against overfitting. Two types of Bayesian approaches are
illustrated using two different software packages: JASP and the R
package \texttt{rstanarm}. The R Markdown document containing this paper
can be downloaded from
\url{https://wdenooy.github.io/Switch2Bayesian/HelpMyCollaboratorGoesBayesian.Rmd}.
The PDF version is available at
\url{https://wdenooy.github.io/Switch2Bayesian/HelpMyCollaboratorGoesBayesian.pdf}.
